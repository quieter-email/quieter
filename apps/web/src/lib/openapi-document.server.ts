export const openApiDocument = {
  ...
  info: {
    description:
      "REST API for sending mail from verified sender domains and reading delivery state and suppressions. Authenticate every request with a bearer team API key.",
    title: "Quieter API",
    version: "0.1.0",
  },
  openapi: "3.1.0",
