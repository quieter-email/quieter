        ...
        {attachments.map((attachment) => {
          ...
          return (
            <button
              ...
              className="inline-flex max-w-full items-center gap-2 rounded-full border border-border/70 bg-background px-3 py-1.5 text-left text-sm font-medium text-foreground transition-colors hover:bg-muted/40 disabled:cursor-progress disabled:opacity-70"
