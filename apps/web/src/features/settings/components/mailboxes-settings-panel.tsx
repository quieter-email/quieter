      ...
      <section className="space-y-4 border-t border-border pt-6">
        ...
        {organizations.length > 0 ? (
          <div className="flex flex-wrap items-end gap-3">
            ...
            <div className="keyboard-focus-within flex h-9 w-72 items-center rounded-md border border-input bg-background shadow-sm transition-colors squircle">
              <TextFieldInput
        ...
        {selectedManagedOrganizationId && (
          <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(22rem,28rem)]">
            ...
            {selectedManagedMailboxDetails ? (
              <div className="space-y-4 rounded-lg border border-border/70 bg-muted/10 p-4 squircle">
                <div>
