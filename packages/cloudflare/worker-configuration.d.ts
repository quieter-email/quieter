/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.types.jsonc --strict-vars=false` (hash: c2ef44aa6518993f59906b1efdca30f9)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "GmailLiveSyncMailboxV2";
	}
