/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.types.jsonc --strict-vars=false` (hash: 97397234d51a9be7be3a149ad7067a08)
...
interface __BaseEnv_Env {
	...
	MailLiveUser: DurableObjectNamespace<import("./src/worker").MailLiveUser>;
	GmailLiveSyncMailboxV2: DurableObjectNamespace<import("./src/worker").GmailLiveSyncMailboxV2>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "GmailLiveSyncMailboxV2" | "MailLiveUser";
	}
