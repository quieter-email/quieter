/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.types.jsonc --strict-vars=false` (hash: 8ff0bdacf44fe9b46baa3c761aaf3f03)
// Runtime types generated with workerd@1.20260730.1 2026-08-04 nodejs_compat
interface __BaseEnv_Env {
	LocalMailStorage: R2Bucket;
	AppDatabaseV2: Hyperdrive;
	MailSubmissionDispatchQueue: Queue;
	MailSubmissionProjectionQueue: Queue;
	MailSubmissionWakeQueue: Queue;
	GmailPsQueue: Queue;
	MailboxActionQueue: Queue;
	...
	SST_RESOURCE_SentryDsn: string;
	GmailLiveSyncMailbox: DurableObjectNamespace<import("./src/worker").GmailLiveSyncMailbox>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "GmailLiveSyncMailbox";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONNECTOR_TOKEN_ENCRYPTION_KEY" | "GMAIL_TOKEN_ENCRYPTION_KEY" | "GMAIL_TOKEN_ENCRYPTION_KEY_CURRENT" | "GMAIL_PUBSUB_PUSH_AUDIENCE" | "GMAIL_PUBSUB_PUSH_SERVICE_ACCOUNT" | "GMAIL_PUBSUB_SUBSCRIPTION" | "GMAIL_PUBSUB_TOPIC" | "GOOGLE_CALENDAR_CLIENT_ID" | "GOOGLE_CALENDAR_CLIENT_SECRET" | "GOOGLE_GMAIL_CLIENT_ID" | "GOOGLE_GMAIL_CLIENT_SECRET" | "LINEAR_CLIENT_ID" | "LINEAR_CLIENT_SECRET" | "OPENROUTER_API_KEY" | "POLAR_ACCESS_TOKEN" | "POLAR_ORGANIZATION_ID" | "POLAR_SANDBOX" | "QUIETER_GMAIL_AI_AUTOMATION_ENABLED" | "SENTRY_ENVIRONMENT" | "SST_RESOURCE_GmailLiveSyncTokenSecret" | "SST_RESOURCE_SentryDsn">> {}
}
