...
export const Checkbox = ({
  ...
  <CheckboxPrimitive.Root
    className={cn(
      "flex size-4 shrink-0 items-center justify-center rounded-md border border-input bg-background-light text-primary-foreground shadow-xs transition-colors duration-150 ease-out outline-none focus-visible:ring-2 focus-visible:ring-ring/30 focus-visible:ring-offset-2 focus-visible:ring-offset-background data-disabled:cursor-not-allowed data-disabled:opacity-50 [&[data-checked]:not([data-indeterminate])]:border-primary [&[data-checked]:not([data-indeterminate])]:bg-primary",
      className,
    )}
    {...props}
  />
