...
export const ToolbarInput = ({
  ...
  <ToolbarPrimitive.Input
    className={cn(
      "keyboard-focus-ring squircle h-8 w-full min-w-32 rounded-md border border-input bg-background-light px-3 text-[13px] text-foreground shadow-sm transition-colors duration-150 ease-out outline-none placeholder:text-muted-foreground read-only:cursor-default read-only:bg-muted/30 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive",
      className,
    )}
    {...props}
  />
