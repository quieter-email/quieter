...
export const ToggleGroup = ({
  ...
  <ToggleGroupPrimitive
    className={cn(
      "inline-flex items-center gap-1 rounded-lg border border-border bg-bg p-1 shadow-sm squircle",
      className
    )}
    {...props}
  />
