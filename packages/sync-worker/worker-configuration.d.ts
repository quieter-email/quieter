/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.types.jsonc --strict-vars=false --env-interface=SyncEnv` (hash: e1cf5afd30cd01551f7e9b02152c378b)
// Runtime types generated with workerd@1.20260907.1 2026-08-04 nodejs_compat
interface __BaseEnv_SyncEnv {
	SyncBodies: R2Bucket;
	MailSyncQueue: Queue;
	SST_RESOURCE_MailSyncSecret: string;
	MailboxSyncObjects: DurableObjectNamespace<import("./src/worker").MailboxSync>;
	UserSyncObjects: DurableObjectNamespace<import("./src/worker").UserSync>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "MailboxSync" | "UserSync";
	}
	interface Env extends __BaseEnv_SyncEnv {}
}
interface SyncEnv extends __BaseEnv_SyncEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SST_RESOURCE_MailSyncSecret">> {}
}
